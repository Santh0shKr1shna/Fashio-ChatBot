...
model.eval()
image = load_rgb(f"{VTON_IMG_UPLOAD_DIR}/static/cloth_web.jpg")
...
b=cv2.imread(f"{VTON_IMG_UPLOAD_DIR}/static/cloth_web.jpg")
b_img = mask* 255
...
cv2.imwrite(f"{VTON_IMG_UPLOAD_DIR}/HR-VITON-main/test/test/cloth/00001_00.jpg",img)
cv2.imwrite(f"{VTON_IMG_UPLOAD_DIR}/HR-VITON-main/test/test/cloth-mask/00001_00.jpg",seg_img)