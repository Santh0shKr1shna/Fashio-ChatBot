...
print("CWD posenet: ", os.getcwd())
VTON_IMG_UPLOAD_DIR = "./Virtual_TON"

name=f"{VTON_IMG_UPLOAD_DIR}/origin"
testfile = name +".jpg"
net = load_model(101, model_dir=f"{VTON_IMG_UPLOAD_DIR}/posenet_models")
net = net.cuda()
...
pose_name = f'{VTON_IMG_UPLOAD_DIR}/HR-VITON-main/test/test/openpose_json/00001_00_keypoints.json' 
